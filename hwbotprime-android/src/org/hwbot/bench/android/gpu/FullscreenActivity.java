...
public class FullscreenActivity extends Activity {
    ...
    protected BenchService bench = new BenchService();
    ...
    View.OnClickListener launchBenchmarkListener = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            try {
                ...
                Future<Number> submit = exec.submit(bench.instantiateBenchmark());
                ...
                try {
                    Number score = submit.get();
                    text.append("Done! Score: " + bench.formatScore(score) + "pps");
                } catch (InterruptedException e) {
                    e.printStackTrace();
