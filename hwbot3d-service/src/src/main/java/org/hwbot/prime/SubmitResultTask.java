...
import org.hwbot.opengl.api.SubmissionStatusAware;
import org.hwbot.opengl.service.BasicResponseStatusHandler;
import org.hwbot.opengl.service.BenchService;
import org.hwbot.opengl.service.SubmitResponse;
...
public class SubmitResultTask extends AsyncTask<Void, Void, SubmitResponse> {
    ...
    public SubmitResponse doInBackground(Void... params) {
        ...
        try {
            ...
            HttpPost req = new HttpPost(BenchService.SERVER + "/submit/api?client=hwbot_prime&clientVersion=" + PrimeBenchService.getInstance().version
                    + "&mode=remote");
