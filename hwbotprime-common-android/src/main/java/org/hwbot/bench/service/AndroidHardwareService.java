...
public class AndroidHardwareService extends Activity implements HardwareService, SensorEventListener {
    ...
    public String getProcessorInfo() {
        ...
        // Log.i(AndroidHardwareService.class.getName(), "meminfo: " + meminfo);
        //
        // String version = execRuntime(new String[] { "cat", "/proc/version" });
        // Log.i(AndroidHardwareService.class.getName(), "version: " + version);
        //
        // String execRuntime = execRuntime(new String[] { "cat", "/proc/cpuinfo" });
        // Log.i(AndroidHardwareService.class.getName(), execRuntime);
